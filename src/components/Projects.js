...
const projects = [
  {
    ...
    image: kanbanBoard,
    description:
      "Built a Kanban board with Next.js, styled with TailwindCSS, and deployed on Firebase for scalability and performance.",
  ...
  },
  {
    ...
    description:
      "Built a responsive landing page with Next.js, styled with TailwindCSS, and deployed on Vercel for scalability and performance.",
